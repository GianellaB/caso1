...
<body>
    <h1>Compartir archivos Gianella<sup class="beta">BETA</sup></h1>
    <div class="content">
        <h3>Sube tus archivos y comparte este enlace temporal: <span>gianella.online/?_=<?php echo $carpetaNombre;?></span></h3>
        <div class="container">
